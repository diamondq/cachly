...
public interface Cache {
     ...
     */
    AccessContext createAccessContext(@Nullable AccessContext pExistingContext,
     ...
     * @return the result
     */
    <K1, K2, K3, K4, V> V get(AccessContext pAccessContext, Key<V> pKey, KeyPlaceholder<K1> pHolder1,
     ...
     * @return the optional result
     */
    <K1, K2, K3, V> Optional<V> getIfPresent(AccessContext pAccessContext, Key<V> pKey,
     ...
     * @return the optional result
     */
    <K1, K2, K3, K4, V> Optional<V> getIfPresent(AccessContext pAccessContext, Key<V> pKey,
                                                 KeyPlaceholder<K1> pHolder1, String pValue1, KeyPlaceholder<K2> pHolder2, String pValue2,
     ...
     * @param pValue1        the value for the first placeholder
     */
    <K1, V> void invalidate(AccessContext pAccessContext, Key<V> pKey, KeyPlaceholder<K1> pHolder1,
                            String pValue1);
     ...
     * @param pValue2        the value for the first placeholder
     */
    <K1, K2, V> void invalidate(AccessContext pAccessContext, Key<V> pKey, KeyPlaceholder<K1> pHolder1,
                                String pValue1, KeyPlaceholder<K2> pHolder2, String pValue2);
