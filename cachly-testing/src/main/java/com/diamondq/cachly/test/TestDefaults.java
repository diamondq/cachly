...
public class TestDefaults {
  ...
  public static class Keys {
    ...
    public static final Key<String>            ACTUAL_ORG =
      KeyBuilder.from(ACTUAL, KeyBuilder.of(Strings.PARTIAL_ORG, Types.STRING));

    public static final KeyPlaceholder<String> ORG        =
      KeyBuilder.placeholder(Strings.PARTIAL_ORG, Types.STRING, ACTUAL_ORG);
